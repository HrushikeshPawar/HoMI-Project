    ...
    def Multiplication(A, B):
        ...
        for f in B_F[::-1]:
            ...
            for A_d in A_D[::-1]:
                ...
                Multiplication[i] = [prod] + Multiplication[i]
                #print(f"\t{f:0>2}  *  {A_d:0>2}  +  {carry_old:0>2}\t=\t{60*carry + prod:0>2}\t=\t60 * {carry:0>2} + {prod:0>2}")
        ...
        for d in B_D[::-1]:
            ...
            for A_f in A_F[::-1]:
                ...
                Multiplication[i] = [prod] + Multiplication[i]
                #print(f"\t{d:0>2}  *  {A_f:0>2}  +  {carry_old:0>2}\t=\t{60*carry + prod:0>2}\t=\t60 * {carry:0>2} + {prod:0>2}")
            ...
            for A_d in A_D[::-1]:
                ...
                Multiplication[i] = [prod] + Multiplication[i]
                #print(f"\t{d:0>2}  *  {A_d:0>2}  +  {carry_old:0>2}\t=\t{60*carry + prod:0>2}\t=\t60 * {carry:0>2} + {prod:0>2}")
